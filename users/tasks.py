...
def send_course_update_email_task(subject, message, recipient_list, last_updated):
    ...
    if time_difference < timedelta(hours=4):
        print("[send_course_update_email_task] Обновление курса было менее 4 часов назад. Рассылка отменена.")
    ...
    print(f"[send_course_update_email_task] Письма отправлены {len(recipient_list)} подписчикам.")
